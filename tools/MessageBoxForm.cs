...
namespace SRL
{
    public partial class MessageBoxForm : Form
    {
        ...
        private void setUI(RightToLeft msg_rtl)
        {
            lblMessageText.RightToLeft = msg_rtl;
        }
        ...
        internal static DialogResult Show(string messageText, RightToLeft msg_rtl=RightToLeft.Yes)
        {
            MessageBoxForm frmMessage = new MessageBoxForm();
            frmMessage.setUI(msg_rtl);
        ...
        internal static DialogResult Show(string messageText, string messageTitle, RightToLeft msg_rtl = RightToLeft.Yes)
        {
            MessageBoxForm frmMessage = new MessageBoxForm();
            frmMessage.setUI(msg_rtl);
            frmMessage.setMessage(messageText);
        ...
        public static DialogResult Show(string messageText, string messageTitle, enumMessageIcon messageIcon, enumMessageButton messageButton, RightToLeft msg_rtl = RightToLeft.Yes)
        {
            MessageBoxForm frmMessage = new MessageBoxForm();
            frmMessage.setUI(msg_rtl);
            frmMessage.setMessage(messageText);
