...
namespace SRL
{
   public class MessageBoxForm2 : Form
    {
        private const int CS_DROPSHADOW = 0x00020000;
        private static MessageBoxForm2 _msgBox;
        ...
        private MessageBoxForm2()
        {
            ...
            _lblMessage.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            _lblTitle.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
        }
        ...
        public static DialogResult Show(string message, string title, Buttons buttons)
        {
            ...
            MessageBoxForm2.InitButtons(buttons);
        ...
        public static DialogResult Show(string message, string title, Buttons buttons, Icon icon, AnimateStyle style)
        {
            ...
            _timer = new Timer();
            Size formSize = MessageBoxForm2.MessageSize(message);

            switch (style)
            {
                case MessageBoxForm2.AnimateStyle.SlideDown:
                    _msgBox.Size = new Size(formSize.Width, 0);
                    _timer.Interval = 1;
                    _timer.Tag = new AnimateMsgBox(formSize, style);
                    break;

                case MessageBoxForm2.AnimateStyle.FadeIn:
                ...
                case MessageBoxForm2.AnimateStyle.ZoomIn:
        ...
        private static void InitButtons(Buttons buttons)
        {
            switch (buttons)
            {
                case MessageBoxForm2.Buttons.AbortRetryIgnore:
                    _msgBox.InitAbortRetryIgnoreButtons();
                    break;

                case MessageBoxForm2.Buttons.OK:
                    _msgBox.InitOKButton();
                    break;

                case MessageBoxForm2.Buttons.OKCancel:
                    _msgBox.InitOKCancelButtons();
                    break;

                case MessageBoxForm2.Buttons.RetryCancel:
                    _msgBox.InitRetryCancelButtons();
                    break;

                case MessageBoxForm2.Buttons.YesNo:
                    _msgBox.InitYesNoButtons();
                    break;

                case MessageBoxForm2.Buttons.YesNoCancel:
        ...
        class AnimateMsgBox
        {
            ...
            public MessageBoxForm2.AnimateStyle Style;

            public AnimateMsgBox(Size formSize, MessageBoxForm2.AnimateStyle style)
            {
    ...
    class AnimateMsgBox1
    {
        public Size FormSize;
        public MessageBoxForm2.AnimateStyle Style;

        public AnimateMsgBox1(Size formSize, MessageBoxForm2.AnimateStyle style)
        {
            this.FormSize = formSize;
            this.Style = style;
        }
